...
class Soldering:
    ...
    def place_to_home(self):
        ...
        offset0 = AngleArm(0,0,self.MAX_HEIGHT,initialAngleDefector)
    ...
    def initialize_length_defector(self):
        ...
        self.protocol.armOrientationBase.setPTPCmd(PositionArm(250, 0, 0, initialAngleDefector), E_ptpMode.MOVJ_XYZ)
